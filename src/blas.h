...
void backward_activation_layer_kernel_gpu(int n, int w, int h, int c, float *input_gpu, float *output_gpu, float *in_delta_gpu, float *out_delta_gpu, float *weights_gpu, float *weights_updates_gpu);
void forward_activation_layer_kernel_gpu(int n, int w, int h, int c, float *input_gpu, float *output_gpu, float *weights_gpu);
